        ...
        <div className="grid grid-cols-5 grid-rows-5 gap-4 w-screen h-screen max-w-6xl max-h-[90vh]">
          ...
          <div className="rounded-3xl col-span-2 row-span-2 col-start-4 flex items-center justify-center  bg-red-300">
            <ChallengeCard
              ...
              // fn_name={challenge.fn_name}
              category="Array"
              prompt="Write a function named sum_even_numbers that takes an array of integers and returns the sum of all even numbers."
            />
          </div>

          {/* Right column middle half */}
          <div className="rounded-3xl col-span-2 row-span-2 row-start-3 col-start-4 bg-yellow-300 flex items-center justify-center">
            <TestCases tests={challenge.tests} />
          </div>

          {/* Bottom right box */}
          <div className="rounded-3xl col-span-2 row-start-5 col-start-4 bg-blue-300 flex items-center justify-center">
            3
          </div>
        </div>
      </div>
